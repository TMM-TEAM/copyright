...
async def start(_, msg):
    ...
    await msg.reply_photo(
        photo="https://graph.org/file/a5c4254679b965d725418.jpg",
        caption=start_txt,
...
gd_buttons = [              
        [
            ...
            InlineKeyboardButton("sᴜᴘᴘᴏʀᴛ", url="https://t.me/tmm_heroku_world"),    
        ]
        ]
